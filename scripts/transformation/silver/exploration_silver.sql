/*
===============================================================================
Script: Silver Layer Data Cleansing & Validation Logic
===============================================================================
Purpose: 
    - Identify Data Quality (DQ) issues in the 'bronze' layer.
    - Test cleansing logic (TRIM, CASE statements, NULL handling).
    - Validate business rules (e.g., Sales = Price * Quantity).
    - Verify data consistency between CRM and ERP sources.
    
Note: This script documents the discovery process used to build the final 
